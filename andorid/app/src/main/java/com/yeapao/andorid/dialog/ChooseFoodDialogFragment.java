...
public class ChooseFoodDialogFragment extends DialogFragment {
    ...
    private ChooseFoodMessageAdapter messageAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.dialog_card_swipe, container, false);
        initView(view);
    ...
    private void initView(View view) {
        final RecyclerView recyclerView = (RecyclerView) view.findViewById(R.id.rv_card_list);
