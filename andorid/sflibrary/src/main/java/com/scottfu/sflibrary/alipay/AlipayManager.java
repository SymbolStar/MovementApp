...
//        }.start();
     ...
     * @param activity
     */
    public static void payOrderV2(final OrderCommitted orderInfo, final String alipayinfo , final Activity activity, final Handler handler) {
        String info = alipayinfo;
        String sign = Rsa.sign(info, Keys.PRIVATE);
//        sign = URLEncoder.encode(sign);
//        info += "&sign=\"" + sign + "\"&" + getSignType();
        Log.i("ExternalPartner", "start pay");
